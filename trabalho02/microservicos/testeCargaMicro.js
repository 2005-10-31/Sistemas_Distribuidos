...
const ROTAS = [
  ...
  {
    url: `${GATEWAY}/utilizadores/1/detalhes`,
    peso: 2,
    descricao: "agregação utilizadores #1",
  },
  {
    url: `${GATEWAY}/utilizadores/2/detalhes`,
    peso: 1,
    descricao: "agregação utilizadores #2",
  },
  {
    url: `${GATEWAY}/utilizadores/3/detalhes`,
    peso: 1,
    descricao: "agregação utilizadores #3",
  },
];
